...
const char* ssid = "HUMAX-64606";
const char* password = "NEdJdTX5LENad";
      ...
      if (client.available()) {             // if there's bytes to read from the client,
        ...
        if (c == '\n') {                    // if the byte is a newline character
          ...
          if (currentLine.length() == 0) {
            ...
            // Web Page Heading
            client.println("<body><h1>ESP32 Web Server_LED</h1>");
            ...
            client.println("<p>GPIO 32 Red - State " + output32State + "</p>");
